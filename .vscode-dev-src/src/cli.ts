...
try {
  pkg = readJsonSync(path.join(import.meta.dirname, "../package.json")) || {};
} catch (e) {
  logger.error(e);
}
...
cli
  .command(
    "[cwd]",
    "Generate package.nls.json and vscode.d.ts for vscode extension development"
  )
