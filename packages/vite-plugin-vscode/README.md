...
[![npm](https://img.shields.io/npm/v/@eastgold15/vite-plugin-vscode)](https://www.npmjs.com/package/@eastgold15/vite-plugin-vscode) ![node-current (scoped)](https://img.shields.io/node/v/@eastgold15/vite-plugin-vscode) ![NPM](https://img.shields.io/npm/l/@eastgold15/vite-plugin-vscode) [![jsDocs.io](https://img.shields.io/badge/jsDocs.io-reference-blue)](https://www.jsdocs.io/package/@eastgold15/vite-plugin-vscode)
...
```bash
# pnpm
pnpm add @eastgold15/vite-plugin-vscode -D

# yarn
yarn add @eastgold15/vite-plugin-vscode -D

# npm
npm i @eastgold15/vite-plugin-vscode -D
```
...
- Add `"@eastgold15/vite-plugin-vscode/types"` to `tsconfig.node.json` or `*.d.ts` file.

`tsconfig.node.json`

```json
{
  "extends": "@eastgold15/tsconfig/node.json",
  "compilerOptions": {
    "tsBuildInfoFile": "./node_modules/.tmp/tsconfig.node.tsbuildinfo",
    "types": [
      "@eastgold15/vite-plugin-vscode/types"
    ]
  },
  "include": [
    "extension",
...
```ts
/// <reference types="@eastgold15/vite-plugin-vscode/types" />
```
...
- [@eastgold15/vscode](https://npmjs.com/package/@eastgold15/vscode): Some utilities to simplify the development of [VSCode Extensions](https://marketplace.visualstudio.com/VSCode).
- [@eastgold15/vscode-dev](https://npmjs.com/package/@eastgold15/vscode-dev): Some development tools to simplify the development of [vscode extensions](https://marketplace.visualstudio.com/VSCode).
- [@eastgold15/vscode-webview](https://npmjs.com/package/@eastgold15/vscode-webview): Optimize the `postMessage` issue between `webview` page and [vscode extensions](https://marketplace.visualstudio.com/VSCode)
