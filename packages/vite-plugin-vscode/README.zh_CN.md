...
- 添加 `"@eastgold15/vite-plugin-vscode/types"` 到 `tsconfig.node.json` 或 `*.d.ts`
...
- [@eastgold15/vscode](https://npmjs.com/package/@eastgold15/vscode): 一些实用工具，用于简化 [vscode 扩展](https://marketplace.visualstudio.com/VSCode) 的开发。
- [@eastgold15/vscode-dev](https://npmjs.com/package/@eastgold15/vscode-dev): 一些开发工具，用于简化 [vscode 扩展](https://marketplace.visualstudio.com/VSCode) 的开发。
- [@eastgold15/vscode-webview](https://npmjs.com/package/@eastgold15/vscode-webview): 优化 `webview` 页面与 [vscode 扩展](https://marketplace.visualstudio.com/VSCode) 的 `postMessage` 问题
